...
You will create a file named `prd.md` in the location provided by the user. If the user doesn't specify a location, suggest a default (e.g. `/docs/memories/prd-YYYY-MM-DD.md`, the project's root directory) and ask the user to confirm or provide an alternative.
